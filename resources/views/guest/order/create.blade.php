        ...
        <div class="ms-cart">
            ...
            <form action="/guest/payment" method="GET">
                <div v-show="!flag_cart && !cartShow " class="form-group">
                    ...
                    <button :type="(!readyToPay) ? 'button' : 'submit'" class="btn btn-success" v-on:click='checkBeforePayment()'> Paga </button>
                    <button v-on:click="flag_cart = true , cartShow = true" class='btn btn-success' type='button'>Torna al carrello</button>
                </div>
            </form>
