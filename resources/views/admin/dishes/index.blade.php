    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.dish.create') }}" class="btn btn-primary">
                    Crea nuovo piatto
                </a>
            </div>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Ristorante id</th>{{-- da togliere --}}
                        <th>nome</th>
                        <th>descrizione</th>
                        <th>prezzo</th>
                    ...
                    @foreach ($dishes as $dish)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning btn-sm" href="{{ route('admin.dish.edit', $dish->id) }}">
                                ...
                                <form class="d-inline-block" action="{{ route('admin.dish.destroy', $dish->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
